...
namespace TaskWorker
{
    public partial class Crequest : Form
    {
        ...
        private void btnPost_Click(object sender, EventArgs e)
        {
            ...
            // 4. Validate Minimum Rate (must be > 0 and <= 5)
            ...
            // 5. Validate Hourly Rate and Average Time Needed (must be positive)
            if (hourlyRate <= 0)
            {
            ...
            //        // 1. Insert into dbo.Requests table
            ...
            //            cmd.Parameters.Add("@PreferredTimeSlot", SqlDbType.NVarChar).Value = preferredTimeSlots; // Explicitly set as NVarChar
